import { GAME_HEIGHT, PUSH_BLOCK, ELEVATOR, DOOR, SPIKES, DRAWBRIDGE, ENEMY } from '../config.js';
...
export const LEVEL_05 = {
  ...
  // ── Enemies ────────────────────────────────────────────
  enemies: [
    // Patrols the Level B tower platform
    {
      id: 'enemy1',
      x: TOWER_X,
      y: LEVEL_B - ENEMY.HEIGHT / 2,
      rangeLeft: LEVEL_B_PLATFORM_LEFT + 10,
      rangeRight: LEVEL_B_PLATFORM_RIGHT - 10,
      direction: 'right',
      speed: 90,
      label: '👾',
    },
    // Patrols the Level C mid-section
    {
      id: 'enemy2',
      x: 700,
      y: LEVEL_C - ENEMY.HEIGHT / 2,
      rangeLeft: 550,
      rangeRight: 900,
      direction: 'left',
      speed: 110,
